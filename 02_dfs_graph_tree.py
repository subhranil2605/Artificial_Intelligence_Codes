...
def depth_first_tree_search(problem: GraphProblem) -> list | None:
...
# depth first search
def depth_first_graph_search(problem: GraphProblem) -> list | None:
...
if __name__ == "__main__":
    ...
    graph_search_path: list[Node] = depth_first_graph_search(romania_problem)

    print("\n\nGraph Search")
    print_path(graph_search_path)

    # tree_search_path: list[Node] = depth_first_tree_search(romania_problem)
    # print("\nTree Search")
